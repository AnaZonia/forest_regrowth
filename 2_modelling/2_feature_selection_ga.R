...
optim_ga <- function(par, df = NULL, wrap_optim = wrapper, control = list(), ngen = 50, maxit = 50, ncore = 15, p_change = c(.5, .25, .25)) # p_change - mutation, cross over, co-dominance - issue with none, is that all might be identical 
{
