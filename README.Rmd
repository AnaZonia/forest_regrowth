...
-	All pixels CLASSIFIED AS REGROWING FORESTS IN 2019 ( location_regrowth_mask.tif)
-	All pixels CLASSIFIED AS MATURE FORESTS IN 2019 ( location_mature_mask.tif)
...
1_history_fire
	Intakes MAPBIOMAS raw fire data (./mapbiomas/lulc) and 	location_forest_age.tif  ---- generates fire brick (location_fire_history.tif):
